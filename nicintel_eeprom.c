...
const struct dev_entry nics_intel_ee[] = {
	...
	{PCI_VENDOR_ID_INTEL, 0x151f, OK, "Intel", "I350 Gigabit Network Connection Unprogrammed"},
	...
	{PCI_VENDOR_ID_INTEL, 0x1522, NT, "Intel", "I350 Gigabit Network Connection External SGMII PHY"},
	{0},
};
...
static inline bool is_unprog_device(uint16_t device_id)
{
	switch (device_id)
	{
		case 0x1509: // Unprogrammed 82580 Quad/Dual Gigabit Ethernet Controller
		case 0x151f: // I350 Gigabit Network Connection Unprogrammed
			return true;
		default:
			return false;
	}
